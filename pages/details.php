    ...
    <li>Daran könnte sich mithilfe der <code>Konfiguration</code>
        ...
        <ul>
            <li>Anpassung der <code '.$sty.'>Menüfarben</code>
                ...
                Es wird eine Grundfarbe ausgewählt. Ausgehen von
                dieser werden hellere ähnliche Farbtöne sowie
                eine Komplementärfarbe verwandt.<br/>
                Die RGB-Werte der Grundfarbe müssen &lt;106 sein,
                damit die abgeleiteten Farben fehlerfrei berechnet
                werden können.</li>
            <li>Anpassung der <code '.$sty.'>Stundenleiste</code>
                in den Monats- bzw. Wochen- oder Tagesblättern:<br/>
            ...
            <li>Definition von <code '.$sty.'>Terminkategorien</code>,
                ...
                Konfiguration) in der Termintabelle abgelegt wird.<br/>
